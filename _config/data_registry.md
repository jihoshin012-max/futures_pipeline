...
| zone_csv_v2     | touches | ZRA zone touch events (V4/ZRA, 32 cols). Generated by ZRA running on 250-vol bars — must be paired with bar_data_volume. Do not load against bar_data_time or bar_data_tick | P1, P2  | NQ_ZRA_Hist_*.csv         | 03-hypothesis, 04-backtest |
| zone_csv_zb4    | touches | ZB4 zone touch signals (30 cols). Includes ModeAssignment, QualityScore, TotalScore, CascadeState, TFWeightScore, TFConfluence. Generated by ZB4 running on 250-vol bars — must be paired with bar_data_volume | P1, P2  | NQ_ZB4_signals_*.csv      | 03-hypothesis, 04-backtest |
